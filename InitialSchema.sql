...
CREATE TABLE WorkOrder (
    ...
    hard_deadline_stamp TIMESTAMP(3) NOT NULL,
    estimated_hours NUMBER(5,2) NOT NULL CHECK (estimated_hours >= 0),
    actual_hours NUMBER(5,2) NOT NULL CHECK (actual_hours >= 0),
    client_id VARCHAR2(10) NOT NULL,
